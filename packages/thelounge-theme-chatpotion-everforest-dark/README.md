# ChatPotion Everforest Dark

Everforest Dark theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Everforest Dark preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/everforest-dark.png)
...
```sh
thelounge install thelounge-theme-chatpotion-everforest-dark
```
