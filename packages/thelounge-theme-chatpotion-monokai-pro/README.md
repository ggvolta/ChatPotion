# ChatPotion Monokai Pro

Monokai Pro theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.
...
```sh
thelounge install thelounge-theme-chatpotion-monokai-pro
```
