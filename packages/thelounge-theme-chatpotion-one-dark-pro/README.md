# ChatPotion One Dark Pro

One Dark Pro theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![One Dark Pro preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/one-dark-pro.png)
...
```sh
thelounge install thelounge-theme-chatpotion-one-dark-pro
```
