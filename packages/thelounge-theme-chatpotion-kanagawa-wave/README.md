# ChatPotion Kanagawa Wave

Kanagawa Wave theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Kanagawa Wave preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/kanagawa-wave.png)
...
```sh
thelounge install thelounge-theme-chatpotion-kanagawa-wave
```
