# ChatPotion Dracula Soft

Dracula Soft theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Dracula Soft preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/dracula-soft.png)
...
```sh
thelounge install thelounge-theme-chatpotion-dracula-soft
```
