# ChatPotion Rosé Pine Moon

Rosé Pine Moon theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Rosé Pine Moon preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/rose-pine-moon.png)
...
```sh
thelounge install thelounge-theme-chatpotion-rose-pine-moon
```
