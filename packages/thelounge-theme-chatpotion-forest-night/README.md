# ChatPotion Forest Night

Forest Night theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Forest Night preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/forest-night.png)
...
```sh
thelounge install thelounge-theme-chatpotion-forest-night
```
