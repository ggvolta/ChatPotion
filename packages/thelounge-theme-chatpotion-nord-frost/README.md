# ChatPotion Nord Frost

Nord Frost theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Nord Frost preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/nord-frost.png)
...
```sh
thelounge install thelounge-theme-chatpotion-nord-frost
```
