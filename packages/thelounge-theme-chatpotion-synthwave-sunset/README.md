# ChatPotion Synthwave Sunset

Synthwave Sunset theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Synthwave Sunset preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/synthwave-sunset.png)
...
```sh
thelounge install thelounge-theme-chatpotion-synthwave-sunset
```
