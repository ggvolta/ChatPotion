# ChatPotion Tokyo Night

Tokyo Night theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Tokyo Night preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/tokyo-night.png)
...
```sh
thelounge install thelounge-theme-chatpotion-tokyo-night
```
