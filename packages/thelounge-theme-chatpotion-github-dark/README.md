# ChatPotion GitHub Dark

GitHub Dark theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![GitHub Dark preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/github-dark.png)
...
```sh
thelounge install thelounge-theme-chatpotion-github-dark
```
