# ChatPotion Deep Sea Cyan

Deep Sea Cyan theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Deep Sea Cyan preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/deep-sea-cyan.png)
