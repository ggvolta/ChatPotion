# ChatPotion Matrix Terminal

Matrix Terminal theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Matrix Terminal preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/matrix-terminal.png)
...
```sh
thelounge install thelounge-theme-chatpotion-matrix-terminal
```
