# ChatPotion Arctic Aurora

Arctic Aurora theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Arctic Aurora preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/arctic-aurora.png)
...
```sh
thelounge install thelounge-theme-chatpotion-arctic-aurora
```
