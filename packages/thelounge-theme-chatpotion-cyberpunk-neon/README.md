# ChatPotion Cyberpunk Neon

Cyberpunk Neon theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Cyberpunk Neon preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/cyberpunk-neon.png)
...
```sh
thelounge install thelounge-theme-chatpotion-cyberpunk-neon
```
