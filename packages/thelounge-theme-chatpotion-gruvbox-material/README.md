# ChatPotion Gruvbox Material

Gruvbox Material theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Gruvbox Material preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/gruvbox-material.png)
...
```sh
thelounge install thelounge-theme-chatpotion-gruvbox-material
```
