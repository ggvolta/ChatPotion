# ChatPotion Solarized Night

Solarized Night theme from **ChatPotion** for [The Lounge](https://thelounge.chat/) IRC client.

![Solarized Night preview](https://raw.githubusercontent.com/ggvolta/ChatPotion/main/screenshots/solarized-night.png)
...
```sh
thelounge install thelounge-theme-chatpotion-solarized-night
```
